...
public class HelpDeskSystem extends Application {
    ...
    private void createList(ArrayList<ServiceRequest> itemList, boolean newRow) {
        ...
        for (ServiceRequest item : itemList) {
            ...
            ListRow listRow = new ListRow(this.primaryStage, item, idx);
    ...
    private void setScrolling() {
        ...
        mainList.setOnScroll(e -> {
            ...
            if (trans < visibleListHeight - mainList.getHeight()) {
                ...
                new SimpleAnimation(mainScrollBar.valueProperty(), 25, Math.abs(visibleListHeight - mainList
                        .getHeight())).play();
            } else if (trans >= 0) {
    ...
    private void createColumnNames() throws IOException {
        ...
        VBox test = new VBox(new IconView("up-down-arrow.png"));

        Label l1 = new Label("Date Created");
        Label l2 = new Label("Status");
        Label l3 = new Label("Date Completed");
        Label l4 = new Label("Description");
        Label l5 = new Label("Technician");
        ...
        GridPane.setHalignment(l5, HPos.CENTER);


        ColumnConstraints colConstraint = new ColumnConstraints();
        colConstraint.setPercentWidth(20);
        pane.getColumnConstraints().addAll(colConstraint, colConstraint, colConstraint, colConstraint, colConstraint);
